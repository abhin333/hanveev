            ...
            var LocsA = [
                {
                    ...
                    html: [ '<div class="ltn__map-product-item">',
                                '<a href="#"><img src="/static/frontend/img/product-3/1.jpg" alt="#"></a>',
                ...
                },
                {
                    ...
                    title: 'Location 2',
                    html: [ '<div class="ltn__map-product-item">',
                                '<a href="#"><img src="/static/frontend/img/product-3/2.jpg" alt="#"></a>',
                                '<h5 class="ltn__map-product-title"><a href="#">House in Upper East Side</a></h5>',
                                '<h5 class="ltn__map-product-price">$30,000</h5>',
                                '<p class="ltn__map-product-info"><span>3 Bed</span><span>3 Bath</span><span>1220 ft<sup>2</sup></span></p>',
                                '<p class="ltn__map-product-location"><i class="flaticon-pin"></i>Boston, New York</span>',
                ...
                },
                {
                    ...
                    title: 'Location 3',
                    html: [ '<div class="ltn__map-product-item">',
                                '<a href="#"><img src="/static/frontend/img/product-3/3.jpg" alt="#"></a>',
                                '<h5 class="ltn__map-product-title"><a href="#">House in Upper East Side</a></h5>',
                                '<h5 class="ltn__map-product-price">$30,000</h5>',
                                '<p class="ltn__map-product-info"><span>3 Bed</span><span>3 Bath</span><span>1220 ft<sup>2</sup></span></p>',
                                '<p class="ltn__map-product-location"><i class="flaticon-pin"></i>Boston, New York</span>',
                ...
                },
                {
                    ...
                    title: 'Location 4',
                    html: [ '<div class="ltn__map-product-item">',
                                '<a href="#"><img src="/static/frontend/img/product-3/4.jpg" alt="#"></a>',
                                '<h5 class="ltn__map-product-title"><a href="#">House in Upper East Side</a></h5>',
                                '<h5 class="ltn__map-product-price">$30,000</h5>',
                                '<p class="ltn__map-product-info"><span>3 Bed</span><span>3 Bath</span><span>1220 ft<sup>2</sup></span></p>',
                                '<p class="ltn__map-product-location"><i class="flaticon-pin"></i>Boston, New York</span>',
                ...
                },
                {
                    ...
                    title: 'Location 5',
                    html: [ '<div class="ltn__map-product-item">',
                                '<a href="#"><img src="/static/frontend/img/product-3/5.jpg" alt="#"></a>',
                                '<h5 class="ltn__map-product-title"><a href="#">House in Upper East Side</a></h5>',
                                '<h5 class="ltn__map-product-price">$30,000</h5>',
                                '<p class="ltn__map-product-info"><span>3 Bed</span><span>3 Bath</span><span>1220 ft<sup>2</sup></span></p>',
                                '<p class="ltn__map-product-location"><i class="flaticon-pin"></i>Boston, New York</span>',
                ...
                },
                {
                    ...
                    title: 'Location 6',
                    html: [ '<div class="ltn__map-product-item">',
                                '<a href="#"><img src="/static/frontend/img/product-3/6.jpg" alt="#"></a>',
                                '<h5 class="ltn__map-product-title"><a href="#">House in Upper East Side</a></h5>',
                                '<h5 class="ltn__map-product-price">$30,000</h5>',
                                '<p class="ltn__map-product-info"><span>3 Bed</span><span>3 Bath</span><span>1220 ft<sup>2</sup></span></p>',
                                '<p class="ltn__map-product-location"><i class="flaticon-pin"></i>Boston, New York</span>',
